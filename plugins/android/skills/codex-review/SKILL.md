---
name: codex-review
description: Review code changes using Codex MCP server
...
Read the guidelines from [review-base.md](review-base.md) and follow Step 4 (Generate Customized Prompt), using this Codex-specific introduction template:
